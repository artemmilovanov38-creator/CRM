...
const emptyMetrics = {
  ...
  approvedAmount: 0,
  salaryFund: 0,
  applicationsWithoutProduct: 0,
  approvedWithoutRate: 0,
...
export default function Reports() {
  ...
  function handleExport() {
    const rows =
      report.applications.map(
        (application) => ({
          ...
          Продукт:
            getApplicationProductName(
              application
            ),

          "Стоимость открытия":
            getApplicationProductRate(
              application
            ),
    ...
    downloadCsv(
      rows,
      `report-${
        dateRange.dateFrom || "all"
      }-${
        dateRange.dateTo || "all"
      }.csv`
    );
  }
  ...
  return (
    <main className="page">
      <div className="page-header">
        <div>
          ...
          <p className="page-description">
            Аналитика заявок, продуктов,
            выплат и эффективности
            менеджеров.
          </p>
        </div>
      ...
      <section className="reports-metrics-grid">
        ...
        <MetricCard
          icon={CheckCircle2}
          iconClass="reports-metric-icon--green"
          title="Успешные открытия"
          value={formatNumber(
        ...
        <MetricCard
          icon={XCircle}
          iconClass="reports-metric-icon--red"
          title="Отказы"
          value={formatNumber(
        ...
        <MetricCard
          icon={Filter}
          iconClass="reports-metric-icon--purple"
          title="Конверсия"
          value={`${report.metrics.conversion}%`}
          description="Из заявки в открытие"
        />

        <MetricCard
          icon={CircleDollarSign}
          iconClass="reports-metric-icon--pink"
          title="Фонд выплат"
          value={formatMoney(
      ...
      <div className="reports-main-grid">
        <section className="reports-chart-card">
          <ReportCardHeading
            ...
            description="Количество заявок по дням"
            icon={TrendingUp}
          />
        ...
        <section className="reports-products-card">
          <ReportCardHeading
            title="Продукты"
            description="Результаты и выплаты по продуктам"
            icon={WalletCards}
          />

          {report.productStats.length >
          0 ? (
            <ProductsList
              products={
                report.productStats
      ...
      <div className="reports-secondary-grid">
        <section className="reports-ranking-card">
          <ReportCardHeading
            ...
            description="Лидер по успешным открытиям"
            icon={Trophy}
          />
          ...
          {bestManager ? (
            ...
            <EmptyReportState
              title="Нет данных"
              description="Успешные открытия отсутствуют"
            />
          )}
        </section>
        ...
        <section className="reports-status-card">
          <ReportCardHeading
            ...
            description="Распределение заявок"
            icon={Filter}
          />

          {report.statusStats.length >
          0 ? (
        ...
        <section className="reports-sources-card">
          <ReportCardHeading
            ...
            description="Эффективность каналов"
            icon={TrendingUp}
          />

          {report.sourceStats.length >
          0 ? (
      ...
      <section className="reports-managers-card">
        <ReportCardHeading
          ...
          description="Заявки, открытия, конверсия и выплаты"
          icon={Users}
          managers
        />
...
function ReportCardHeading({
  ...
  return (
    <div
      className={
        managers
          ? "reports-card-heading reports-card-heading--managers"
...
function getApplicationProductName(
  application
) {
  return (
